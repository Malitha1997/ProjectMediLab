...
<div class="container-fluid" data-aos="fade-down" data-aos-duration="1000">
    ...
    </div><button class="btn btn-primary" type="button" data-aos="fade-down" data-aos-duration="1000" style="padding: 5px 10px;margin-left: 20px;margin-top: 5px;"><a href="{{route('report_list-labassistant')}}"><span style="--bs-body-color: var(--bs-btn-color);padding-right: 5px;margin-left: 5px;margin-right: 5px;"><span style="color: rgb(255, 255, 255);">Report list</span></span></a></button>
