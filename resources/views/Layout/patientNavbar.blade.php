        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="padding-right: 0px;padding-left: 4px;margin-left: 0px;margin-right: 1px;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#" style="margin-left: 3px;padding-left: 0px;padding-right: 0px;margin-right: -16px;"><span style="font-size: 14px;">Medilab</span></a>
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" aria-expanded="false"  href="/add_appointment-patient" style="padding-left: 7px;padding-right: 20px;">&nbsp; <svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#" style="padding-left: 15px;padding-right: 20px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                        ...
                        <div class="dropdown-menu"><a class="dropdown-item" href="Service_list.html">Service list</a><a class="dropdown-item" href="Package_list.html">Package list</a></div>
                    </li>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link active" href="home" style="margin-top: -12px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -64 640 640" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
