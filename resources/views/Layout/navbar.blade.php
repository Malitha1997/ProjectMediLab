            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#" style="margin-left: 3px;padding-left: 0px;padding-right: 0px;margin-right: -16px;"><span style="font-size: 14px;">MediLab</span></a><a href="#">Link</a>
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="profile.html" style="margin-left: 0px;padding-right: 20px;padding-left: 15px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                            ...
                            </svg><span><strong>&nbsp; </strong>Profile</span></a></li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="" style="margin-right: 0px;padding-right: 20px;padding-left: 15px;margin-left: 0px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor" id="patient" style="font-size: 14px;">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                        ...
                        <div class="dropdown-menu"><a class="dropdown-item" href="Add_patient.html">Add patient<span></span></a><a class="dropdown-item" href="Patient_list.html">Patient list<span></span></a></div>
                    </li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#" style="padding-left: 6px;padding-right: 20px;margin-left: 0px;">&nbsp; <svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                        ...
                        <div class="dropdown-menu"><a class="dropdown-item" href="Add_doctor.html">Add doctor</a><a class="dropdown-item" href="Doctor_list.html">Doctor list</a></div>
                    </li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#" style="padding-right: 20px;margin-left: 0px;padding-left: 13px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                        ...
                        <div class="dropdown-menu"><a class="dropdown-item" href="Add_schedule.html">Add schedule</a><a class="dropdown-item" href="Package_list.html">Schedule list</a></div>
                    </li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#" style="padding-left: 7px;padding-right: 20px;">&nbsp; <svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                        ...
                        <div class="dropdown-menu"><a class="dropdown-item" href="Add_appointment.html">Add appointment</a><a class="dropdown-item" href="#">Appointment list</a><a class="dropdown-item" href="Appointment_assign_by_all.html">Assign by all</a><a class="dropdown-item" href="Appointment_assign_by_doctor.html">Assign by doctor</a></div>
                    </li>
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#" style="padding-left: 10px;padding-right: 20px;">&nbsp;<svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                            ...
                            </svg>&nbsp; &nbsp;<span>Notice board</span></a>
                        <div class="dropdown-menu"><a class="dropdown-item" href="#">Add notice</a><a class="dropdown-item" href="#">Notice list</a></div>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="#" style="padding-left: 14px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                            ...
                            </svg><span><strong>&nbsp; &nbsp;</strong><span style="font-weight: normal !important;">Inquiry</span></span></a></li>
                    <li class="nav-item"><a class="nav-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                            ...
                            </svg><span>&nbsp; &nbsp;<span style="font-weight: normal !important;">Settings</span></span></a></li>
                </ul>
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link active" href="#" style="margin-top: -12px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -64 640 640" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                            ...
                            </svg><span>&nbsp; &nbsp;<span style="font-weight: normal !important;">Logout</span></span></a></li>
                </ul>
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">Malitha Yasas</span><img class="border rounded-circle img-profile" src="{{asset('img/avatars/avatar5.jpeg')}}"></a>
