@extends('Layout.navbar')
       @section('content')
                <div class="container-fluid">
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-info py-2" data-aos="fade-down" data-aos-duration="1000">
                                <div class="card-body" data-aos="fade-down" data-aos-duration="1000">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-info fw-bold text-xs mb-1"><span>appointments</span></div>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-xl-8" data-aos="fade-down" data-aos-duration="1000">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center" data-aos="fade-down" data-aos-duration="1000">
                                    <h6 class="text-primary fw-bold m-0">Showing status from last year</h6>
