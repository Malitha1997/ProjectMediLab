        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline text-dark mb-1">
            ...
            <div class="col-lg-4">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-dark mb-1"><a href="#">Available time</a></li>
                        <li class="breadcrumb-item active text-dark mb-1" aria-current="page">Create</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <form action="{{ route('appointment.store') }}" method="post">
                @csrf
                <div class="card">
                    <div class="card-header text-dark mb-1">
                        <h3>Choose A Date</h3>
                    </div>
                    <div class="card-body">
