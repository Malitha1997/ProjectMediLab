...
<body>
    <nav class="navbar navbar-light navbar-expand-md bg-light shadow-sm py-3 fixed-top" data-aos="fade-down" data-aos-duration="950" style="border-width: 0px;border-color: rgb(42,132,222);">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
            ...
            <div class="collapse navbar-collapse" data-aos="fade" data-aos-once="true" id="navcol-2">
                ...
                </ul><button class="btn btn-primary" type="button"><a href="Signup.html"><span><span style="color: rgb(255, 255, 255);">Signup</span></span></a></button>
            </div><button class="btn btn-primary" id="btn_login" type="button"><a href="User_Login.html"><span><span style="color: rgb(255, 255, 255);">Login</span></span></a></button>
        </div>
    </nav>
    <div id="banar" class="banar">
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body pt-5 p-4" style="--bs-body-bg: #ffffff;">
                                ...
                                <h4 class="card-title">How we work</h4>
        ...
        <div id="content" class="content">
            <h1 data-aos="fade-down" data-aos-duration="1000" id="h1" class="h1" style="border-color: rgb(0,0,0);text-shadow: 0px 0px;--bs-body-color: #000000;">Make your day today life healthy</h1>
        </div>
        <div class="col">
